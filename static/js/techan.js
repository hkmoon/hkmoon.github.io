...
var adx = function adx() {
  var date = function date(d) {
    ...
    return d.adx;
      ...
      plusDi = function plusDi(d) {
    return d.plusDi;
  },
      minusDi = function minusDi(d) {
    return d.minusDi;
  };
...
exports.aroon = void 0;

var aroon = function aroon() {
  var date = function date(d) {
    return d.date;
  },
      up = function up(d) {
    return d.up;
      ...
      down = function down(d) {
    return d.down;
  },
      oscillator = function oscillator(d) {
    return d.oscillator;
  },
      overbought = function overbought(d) {
    return d.overbought;
  },
      oversold = function oversold(d) {
    return d.oversold;
  },
      middle = function middle(d) {
    return d.middle;
  };
...
exports.atrtrailingstop = void 0;

var atrtrailingstop = function atrtrailingstop() {
  var date = function date(d) {
    return d.date;
  },
      up = function up(d) {
...
exports.atrtrailingstop = atrtrailingstop;
...
var bollinger = function bollinger() {
  var date = function date(d) {
    return d.date;
  },
      middle = function middle(d) {
...
exports.ichimoku = void 0;

var ichimoku = function ichimoku() {
  var date = function date(d) {
    return d.date;
  },
      tenkanSen = function tenkanSen(d) {
    return d.tenkanSen;
  },
      // Conversion line
  kijunSen = function kijunSen(d) {
    return d.kijunSen;
  },
      // Base Line
  senkouSpanA = function senkouSpanA(d) {
    return d.senkouSpanA;
  },
      // Leading Span A
  senkouSpanB = function senkouSpanB(d) {
    return d.senkouSpanB;
  },
      // Leading Span B
  chikouSpan = function chikouSpan(d) {
    return d.chikouSpan;
  },
      // Lagging Span
  // Functions to get to the parameters
  ptenanSen = function ptenanSen(d) {
    return d.parameters.tenkanSen;
  },
      // Parameter: Conversion Line Period
  pkijunSen = function pkijunSen(d) {
    return d.parameters.kijunSen;
  },
      // Parameter: Base Line Period, Offset
  psenkouSpanB = function psenkouSpanB(d) {
...
var _atrtrailingstop = require("./atrtrailingstop");

var _crosshair = require("./crosshair");

var _ichimoku = require("./ichimoku");
...
var _aroon = require("./aroon");

var _stochastic = require("./stochastic");

var _supstance = require("./supstance");

var _williams = require("./williams");
...
var accessors = function accessors() {
  return {
    atrtrailingstop: _atrtrailingstop.atrtrailingstop,
    crosshair: _crosshair.crosshair,
    ichimoku: _ichimoku.ichimoku,
    macd: _macd.macd,
    ohlc: _ohlc.ohlc,
    rsi: _rsi.rsi,
    trendline: _trendline.trendline,
    value: _value.value,
    ...
    adx: _adx.adx,
    aroon: _aroon.aroon,
    stochastic: _stochastic.stochastic,
    supstance: _supstance.supstance,
    williams: _williams.williams,
    bollinger: _bollinger.bollinger
  };
};
...
var macd = function macd() {
  var date = function date(d) {
    return d.date;
  },
      macd = function macd(d) {
    return d.macd;
  },
      zero = function zero(d) {
    return d.zero;
  },
      signal = function signal(d) {
    return d.signal;
  },
...
var stochastic = function stochastic() {
  var date = function date(d) {
    return d.date;
  },
      stochasticK = function stochasticK(d) {
    return d.stochasticK;
  },
      stochasticD = function stochasticD(d) {
...
exports.supstance = void 0;

var supstance = function supstance() {
  var start = function start(d) {
    return d.start;
  },
      end = function end(d) {
    return d.end;
...
exports.trendline = void 0;

var trendline = function trendline() {
  var startDate = function startDate(d, _) {
    if (arguments.length < 2) return d.start.date;
    d.start.date = _;
  },
      startValue = function startValue(d, _) {
    if (arguments.length < 2) return d.start.value;
    d.start.value = _;
  },
      endDate = function endDate(d, _) {
    if (arguments.length < 2) return d.end.date;
    d.end.date = _;
  },
      endValue = function endValue(d, _) {
...
exports.williams = void 0;

var williams = function williams() {
  var date = function date(d) {
    return d.date;
  },
      williams = function williams(d) {
    return d.williams;
  };
...
var adx = function adx(d3_max, indicatorMixin, accessor_ohlc, indicator_ema) {
...
var aroon = function aroon(indicatorMixin, accessor_ohlc) {
  // Injected dependencies
  return function () {
    // Closure function
    var p = {},
...
exports.atr_init = void 0;

var atr_init = function atr_init(indicatorMixin, accessor_ohlc, indicator_sma) {
  // Injected dependencies
  return function () {
    // Closure function
    var p = {},
...
var atrtrailingstop = function atrtrailingstop(indicatorMixin, accessor_ohlc, indicator_atr) {
  // Injected dependencies
  return function () {
    // Closure function
    var p = {},
...
var bollinger = function bollinger(indicatorMixin, accessor_ohlc, indicator_sma) {
  // Injected dependencies
  return function () {
    // Closure function
    var p = {},
...
exports.ema_init = void 0;

var ema_init = function ema_init(indicatorMixin, accessor_ohlc, alpha_init) {
  // Injected dependencies
  return function () {
    // Closure function
    var p = {},
...
exports.heikinashi = void 0;

var heikinashi = function heikinashi(indicatorMixin, accessor_ohlc, min, max) {
  // Injected dependencies
  //Injected dependencies
  return function () {
    // Closure function  
...
var ichimoku = function ichimoku(indicatorMixin, accessor_ohlc) {
  // Injected dependencies
  return function () {
    // Closure function
    var p = {},
    ...
    function calculate(parameters, data, index) {
      var d = data[index],
          min = p.accessor.l(d),
          max = p.accessor.h(d),
          current = datum(parameters, p.accessor.d(d), p.accessor.c(d)); // Iterate backwards through the data up to sendouSpanB count to calculate averages
...
var _indicatormixin = require("./indicatormixin");
...
var indicators = function indicators(d3) {
  var indicatorMixin = (0, _indicatormixin.indicatormixin)(),
      accessor = (0, _accessor.accessors)(),
      ema = (0, _ema.ema_init)(indicatorMixin, accessor.ohlc, ema_alpha_init),
      sma = (0, _sma.sma_init)(indicatorMixin, accessor.ohlc),
      atr = (0, _atr.atr_init)(indicatorMixin, accessor.ohlc, sma),
      circularbuffer = (0, _util.util)().circularbuffer;
  return {
    atr: atr,
    atrtrailingstop: (0, _atrtrailingstop.atrtrailingstop)(indicatorMixin, accessor.ohlc, atr),
    ema: ema,
    heikinashi: (0, _heikinashi.heikinashi)(indicatorMixin, accessor.ohlc, d3.min, d3.max),
    ichimoku: (0, _ichimoku.ichimoku)(indicatorMixin, accessor.ohlc),
    macd: (0, _macd.macd)(indicatorMixin, accessor.ohlc, ema),
    rsi: (0, _rsi.rsi)(indicatorMixin, accessor.ohlc, ema),
    sma: sma,
    wilderma: (0, _ema.ema_init)(indicatorMixin, accessor.ohlc, wilder_alpha_init),
    aroon: (0, _aroon.aroon)(indicatorMixin, accessor.ohlc),
    roc: (0, _sroc.sroc_init)(circularbuffer, indicatorMixin, accessor.ohlc, ema, 1),
    sroc: (0, _sroc.sroc_init)(circularbuffer, indicatorMixin, accessor.ohlc, ema, 13),
    stochastic: (0, _stochastic.stochastic)(indicatorMixin, accessor.ohlc, ema),
    williams: (0, _williams.williams)(indicatorMixin, accessor.ohlc, ema),
    adx: (0, _adx.adx)(d3.max, indicatorMixin, accessor.ohlc, ema),
    bollinger: (0, _bollinger.bollinger)(indicatorMixin, accessor.ohlc, sma),
    vwap: (0, _vwap.vwap)(indicatorMixin, accessor.ohlc)
  };
};
...
exports.indicatormixin = void 0;

var indicatormixin = function indicatormixin() {
...
exports.indicatormixin = indicatormixin;
...
var macd = function macd(indicatorMixin, accessor_ohlc, indicator_ema) {
  // Injected dependencies
  return function () {
    // Closure function
    var p = {},
    ...
    function indicator(data) {
      ...
      return data.map(function (d, i) {
        ...
        if (i >= minCount) return datum(p.accessor.d(d), macd, signalValue, macd - signalValue, 0);else return datum(p.accessor.d(d));
      }).filter(function (d) {
        return d.macd !== null;
      });
    }
...
var rsi = function rsi(indicatorMixin, accessor_ohlc, indicator_ema) {
  // Injected dependencies
  return function () {
    // Closure function
    var p = {},
...
exports.sma_init = void 0;

var sma_init = function sma_init(indicatorMixin, accessor_ohlc) {
  // Injected dependencies
  return function () {
    // Closure function
    var p = {},
...
exports.sroc_init = void 0;

var sroc_init = function sroc_init(techan_util_circularbuffer, indicatorMixin, accessor_ohlc, indicator_smoothing, smoothed_period) {
  // Injected dependencies
  return function () {
    // Closure function
    var p = {},
...
var stochastic = function stochastic(indicatorMixin, accessor_ohlc) {
  // Injected dependencies
  return function () {
    // Closure function
    var p = {},
...
var vwap = function vwap(indicatorMixin, accessor_ohlc) {
  // Injected dependencies
  return function () {
    // Closure function
    var p = {},
...
var williams = function williams(indicatorMixin, accessor_ohlc) {
  // Injected dependencies
  var p = {},
      // Container for private, direct access mixed in variables
  overbought = 80,
...
var adx = function adx(accessor_adx, plot, plotMixin) {
  // Injected dependencies
  return function () {
    // Closure function
    var p = {},
...
var aroon = function aroon(accessor_aroon, plot, plotMixin) {
  // Injected dependencies
  return function () {
    // Closure function
    var p = {},
    ...
    aroon.refresh = function (g) {
      refresh(p.dataSelector.select(g), p.accessor, p.xScale, p.yScale, plot, oscLine, oscArea, middleLine, upLine, downLine);
    };
...
var atrtrailingstop = function atrtrailingstop(accessor_atrtrailingstop, plot, plotMixin) {
  // Injected dependencies
  return function () {
    // Closure function
    var p = {},
...
exports.axisannotation = void 0;

/**
 * TODO Refactor this to techan.plot.annotation.axis()?
 */
var axisannotation = function axisannotation(d3_svg_axis, d3_scale_linear, accessor_value, plot, plotMixin) {
  // Injected dependencies
  return function () {
    // Closure function
    var p = {},
...
var bollinger = function bollinger(accessor_bollinger, plot, plotMixin) {
  // Injected dependencies
  return function () {
    // Closure function
    var p = {},
...
var candlestick = function candlestick(d3_scale_linear, d3_extent, accessor_ohlc, plot, plotMixin) {
  // Injected dependencies
  return function () {
    // Closure function
    var p = {},
...
var crosshair = function crosshair(d3_select, d3_event, d3_mouse, d3_dispatch, accessor_crosshair, plot, plotMixin) {
  // Injected dependencies
  return function () {
    // Closure function
    var p = {},
...
var ichimoku = function ichimoku(d3_svg_area, d3_line_interpolate, accessor_ichimoku, plot, plotMixin) {
  // Injected dependencies
  return function () {
    // Closure function
    var p = {},
...
var _plot2 = require("./plot");

var _util = require("../util");

var _plotmixin2 = require("./plotmixin");

var _candlestick2 = require("./candlestick");

var _axisannotation2 = require("./axisannotation");
...
var _tradearrow = require("./tradearrow");
...
var plot = function plot(d3) {
  var scale = (0, _scale2.scale)(d3),
      accessor = (0, _accessor.accessors)(),
      plot = (0, _plot2.plot)(d3.line, d3.area, d3.curveMonotoneX, d3.select),
      d3_functor = (0, _util.util)().functor,
      plotMixin = (0, _plotmixin2.plotmixin)(d3.scaleLinear, d3_functor, scale.financetime, plot.dataSelector, plot.barWidth),
      candlestick = (0, _candlestick2.candlestick)(d3.scaleLinear, d3.extent, accessor.ohlc, plot, plotMixin),
      axisannotation = (0, _axisannotation2.axisannotation)(d3.axisTop, d3.scaleLinear, accessor.value, plot, plotMixin),
      svg = (0, _svg2.svg)(d3);
  return {
    adx: (0, _adx.adx)(accessor.adx, plot, plotMixin),
    aroon: (0, _aroon.aroon)(accessor.aroon, plot, plotMixin),
    atr: (0, _line.line)(accessor.value, plot, plotMixin),
    atrtrailingstop: (0, _atrtrailingstop.atrtrailingstop)(accessor.atrtrailingstop, plot, plotMixin),
    axisannotation: axisannotation,
    bollinger: (0, _bollinger.bollinger)(accessor.bollinger, plot, plotMixin),
    candlestick: candlestick,
    close: (0, _line.line)(accessor.ohlc, plot, plotMixin),
    crosshair: (0, _crosshair.crosshair)(d3.select, d3_event, d3.mouse, d3.dispatch, accessor.crosshair, plot, plotMixin),
    ema: (0, _line.line)(accessor.value, plot, plotMixin),
    heikinashi: candlestick,
    ichimoku: (0, _ichimoku.ichimoku)(d3.area, d3.curveMonotoneX, accessor.ichimoku, plot, plotMixin),
    macd: (0, _macd.macd)(accessor.macd, plot, plotMixin),
    momentum: (0, _line.line)(accessor.value, plot, plotMixin, true),
    moneyflow: (0, _line.line)(accessor.value, plot, plotMixin, true),
    ohlc: (0, _ohlc.ohlc)(d3.scaleLinear, d3.extent, accessor.ohlc, plot, plotMixin),
    roc: (0, _line.line)(accessor.value, plot, plotMixin, true),
    rsi: (0, _rsi.rsi)(accessor.rsi, plot, plotMixin),
    sma: (0, _line.line)(accessor.value, plot, plotMixin),
    sroc: (0, _line.line)(accessor.value, plot, plotMixin, true),
    stochastic: (0, _stochastic.stochastic)(accessor.stochastic, plot, plotMixin),
    supstance: (0, _supstance.supstance)(d3.drag, d3_event, d3.select, d3.dispatch, accessor.supstance, plot, plotMixin),
    tick: (0, _tick.tick)(d3.scaleLinear, d3.extent, accessor.tick, plot, plotMixin),
    tradearrow: (0, _tradearrow.tradearrow)(d3.select, d3_functor, d3.mouse, d3.dispatch, accessor.trade, plot, plotMixin, svg.arrow),
    trendline: (0, _trendline.trendline)(d3.drag, d3_event, d3.select, d3.dispatch, accessor.trendline, plot, plotMixin),
    volume: (0, _volume.volume)(accessor.volume, plot, plotMixin),
    vwap: (0, _line.line)(accessor.value, plot, plotMixin),
    wilderma: (0, _line.line)(accessor.value, plot, plotMixin),
    williams: (0, _williams.williams)(accessor.williams, plot, plotMixin)
  };
};

exports.plot = plot;

},{"../accessor":8,"../scale":60,"../svg":63,"../util":66,"./adx":37,"./aroon":38,"./atrtrailingstop":39,"./axisannotation":40,"./bollinger":41,"./candlestick":42,"./crosshair":43,"./ichimoku":44,"./line":46,"./macd":47,"./ohlc":48,"./plot":49,"./plotmixin":50,"./rsi":51,"./stochastic":52,"./supstance":53,"./tick":54,"./tradearrow":55,"./trendline":56,"./volume":57,"./williams":58,"d3":"d3"}],46:[function(require,module,exports){
"use strict";
...
var line = function line(accessor_value, plot, plotMixin, showZero) {
  // Injected dependencies
...
var macd = function macd(accessor_macd, plot, plotMixin) {
  // Injected dependencies
  return function () {
    // Closure function
    var p = {},
...
var ohlc = function ohlc(d3_scale_linear, d3_extent, accessor_ohlc, plot, plotMixin) {
  // Injected dependencies
  return function () {
    // Closure constructor
    var p = {},
...
var plot = function plot(d3_svg_line, d3_svg_area, d3_line_interpolate, d3_select) {
  var DataSelector = function DataSelector(mapper) {
    var key,
        scope,
        classes = ['data'];
  ...
  function PlotComposer() {
    var dataSelector = DataSelector(),
        plots = [],
        plotScale = function plotScale(plot) {
      return plot.scale();
    },
        scale,
        accessor;
  ...
  return {
    ...
    horizontalPathLine: function horizontalPathLine(accessor_date, x, accessor_value, y) {
      return function (d) {
    ...
    pathArea: PathArea,
    barWidth: barWidth,
    scaledStrokeWidth: function scaledStrokeWidth(x, max, div) {
      max = max || 1;
      div = div || 1;
      return function () {
     ...
     */
    joinPath: function joinPath(path) {
      return function (data) {
        return arrayJoin(data.map(path()), ' ');
      };
    },
    interaction: {
      mousedispatch: function mousedispatch(dispatch) {
      ...
      dragStartEndDispatch: function dragStartEndDispatch(drag, dispatch) {
 ...
 */
var plotmixin = function plotmixin(d3_scale_linear, d3_functor, techan_scale_financetime, plot_dataselector, plot_width) {
  var PlotMixin = function PlotMixin(source, priv) {
    var plotMixin = {};
    /**
...
var rsi = function rsi(accessor_rsi, plot, plotMixin) {
  // Injected dependencies
  return function () {
    // Closure function
    var p = {},
...
var stochastic = function stochastic(accessor_stochastic, plot, plotMixin) {
  // Injected dependencies
  return function () {
    // Closure function
    var p = {},
...
var supstance = function supstance(d3_behavior_drag, d3_event, d3_select, d3_dispatch, accessor_supstance, plot, plotMixin) {
  // Injected dependencies
  function Supstance() {
    // Closure function
    var p = {},
...
var tick = function tick(d3_scale_linear, d3_extent, accessor_tick, plot, plotMixin) {
  // Injected dependencies
  return function () {
    // Closure constructor
    var p = {},
...
var tradearrow = function tradearrow(d3_select, d3_functor, d3_mouse, d3_dispatch, accessor_trade, plot, plotMixin, svg_arrow) {
  // Injected dependencies
  return function () {
    // Closure function
    var p = {},
...
var trendline = function trendline(d3_behavior_drag, d3_event, d3_select, d3_dispatch, accessor_trendline, plot, plotMixin) {
  // Injected dependencies
  function Trendline() {
    // Closure function
    var p = {},
...
var volume = function volume(accessor_volume, plot, plotMixin) {
  // Injected dependencies
  return function () {
    // Closure function
    var p = {},
...
var williams = function williams(accessor_williams, plot, plotMixin) {
  // Injected dependencies
  return function () {
    // Closure function
    var p = {},
 ...
 */
var financetime = function financetime(d3_scale_linear, d3_time, d3_bisect, techan_util_rebindCallback, scale_widen, techan_scale_zoomable) {
  // Injected dependencies
...
exports.financetime = financetime;
...
var _zoomable2 = require("./zoomable");

var _accessor = require("../accessor");

var _financetime2 = require("./financetime");

var scale = function scale(d3) {
  var zoomable = (0, _zoomable2.zoomable)(),
      util = (0, _util2.util)(),
      accessors = (0, _accessor.accessors)(),
      financetime = (0, _financetime2.financetime)(d3.scaleLinear, d3, d3.bisect, util.rebindCallback, widen, zoomable);
  ...
  return {
    ...
    plot: {
      ...
      atrtrailingstop: function atrtrailingstop(data, accessor) {
      ...
      bollinger: function bollinger(data, accessor) {
      ...
      heikinashi: ohlc,
      ichimoku: function ichimoku(data, accessor) {
        accessor = accessor || accessors.ichimoku(); // Lots of values in each data point, assemble them together as they are plotted considering offsets, flatten, remove nulls
      ...
      macd: function macd(data, accessor) {
      ...
      ohlc: ohlc,
      percent: function percent(scale, reference) {
      ...
      volume: function volume(data, accessor) {
 ...
 */
var zoomable = function zoomable() {
...
var arrow = function arrow(d3_functor) {
  // Injected dependencies
  return function () {
    var fx = d3_functor(0),
        fy = d3_functor(0),
...
var svg = function svg(d3) {
  return {
    arrow: (0, _arrow2.arrow)((0, _util.util)().functor)
  };
};
...
var _version = require("../build/version");
...
module.exports = function () {
  return {
    ...
    accessor: (0, _accessor.accessors)(),
    indicator: (0, _indicator.indicators)(d3),
    plot: (0, _plot.plot)(d3),
    scale: (0, _scale.scale)(d3),
    svg: (0, _svg.svg)(d3)
  };
}();
...
var util = function util() {
  return {
    circularbuffer: _circularbuffer["default"],
    rebindCallback: rebindCallback,
    rebind: function rebind(target, source) {
